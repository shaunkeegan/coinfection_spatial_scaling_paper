...
#dat17.h <- read.csv("stats output/STATS - Ehung Int NHprev 17.csv", header=T)[,2:5]
#dat34.h <- read.csv("stats output/STATS - Ehung Int NHprev 34.csv", header=T)[,2:5]
#dat51.h <- read.csv("stats output/STATS - Ehung Int NHprev 51.csv", header=T)[,2:5]
#datall.h <- read.csv("stats output/STATS - Ehung Int NHprev all.csv", header=T)[,2:5]

#dat17.a <- read.csv("stats output/STATS - Eapp Int NHprev 17.csv", header=T)[,2:5]
#dat34.a <- read.csv("stats output/STATS - Eapp Int NHprev 34.csv", header=T)[,2:5]
#dat51.a <- read.csv("stats output/STATS - Eapp Int NHprev 51.csv", header=T)[,2:5]
#datall.a <- read.csv("stats output/STATS - Eapp Int NHprev all.csv", header=T)[,2:5]
...
#dat17.a <- read.csv("stats output/STATS - Eapp Int NHMeanburden 17.csv", header=T)[,2:5]
#dat34.a <- read.csv("stats output/STATS - Eapp Int NHMeanburden 34.csv", header=T)[,2:5]
#dat51.a <- read.csv("stats output/STATS - Eapp Int NHMeanburden 51.csv", header=T)[,2:5]
#datall.a <- read.csv("stats output/STATS - Eapp Int NHMeanburden all.csv", header=T)[,2:5]


## EIM BINOMIAL ~ NEMPREV PLOTS
#dat17.h <- read.csv("stats output/STATS - Ehung INF NHprev 17.csv", header=T)[,2:5]
#dat34.h <- read.csv("stats output/STATS - Ehung INF NHprev 34.csv", header=T)[,2:5]
#dat51.h <- read.csv("stats output/STATS - Ehung INF NHprev 51.csv", header=T)[,2:5]
#datall.h <- read.csv("stats output/STATS - Ehung INF NHprev all.csv", header=T)[,2:5]

#dat17.a <- read.csv("stats output/STATS - Eapp INF NHprev 17.csv", header=T)[,2:5]
#dat34.a <- read.csv("stats output/STATS - Eapp INF NHprev 34.csv", header=T)[,2:5]
#dat51.a <- read.csv("stats output/STATS - Eapp INF NHprev 51.csv", header=T)[,2:5]
#datall.a <- read.csv("Sstats output/TATS - Eapp INF NHprev all.csv", header=T)[,2:5]


## EIM BINOMIAL ~ NEMMEANBURDEN PLOTS
dat17.h <- read.csv("stats output/STATS - Ehung INF NHMeanburden 17.csv", header=T)[,2:5]
dat34.h <- read.csv("stats output/STATS - Ehung INF NHMeanburden 34.csv", header=T)[,2:5]
dat51.h <- read.csv("stats output/STATS - Ehung INF NHMeanburden 51.csv", header=T)[,2:5]
datall.h <- read.csv("stats output/STATS - Ehung INF NHMeanburden all.csv", header=T)[,2:5]

dat17.a <- read.csv("stats output/STATS - Eapp INF NHMeanburden 17.csv", header=T)[,2:5]
dat34.a <- read.csv("stats output/STATS - Eapp INF NHMeanburden 34.csv", header=T)[,2:5]
dat51.a <- read.csv("stats output/STATS - Eapp INF NHMeanburden 51.csv", header=T)[,2:5]
datall.a <- read.csv("stats output/STATS - Eapp INF NHMeanburden all.csv", header=T)[,2:5]
